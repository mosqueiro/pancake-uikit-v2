...
var removePointerEvents = function (_a) {
    var isDisabled = _a.isDisabled, as = _a.as;
    if (isDisabled && as !== "button") {
        return "\n      pointer-events: none;\n    ";
    }
    return "";
};
...
var getDisabledState = function (_a) {
    var isDisabled = _a.isDisabled, isLoading = _a.isLoading;
    if (isLoading) {
        return true;
    }
    return isDisabled;
...
function Button(_a) {
    var startIcon = _a.startIcon, endIcon = _a.endIcon, children = _a.children, external = _a.external, isLoading = _a.isLoading, _b = _a.isDisabled, isDisabled = _b === void 0 ? false : _b, props = __rest(_a, ["startIcon", "endIcon", "children", "external", "isLoading", "isDisabled"]);
    var disabledState = getDisabledState({ isDisabled: isDisabled, isLoading: isLoading });
    ...
    return (React.createElement(StyledButton, __assign({}, internalProps, elementProps, props),
...
var Alert = function (_a) {
    ...
    return (React.createElement(StyledAlert, { hasDescription: !!description },
        React.createElement(IconLabel, { variant: variant, hasDescription: !!description },
            React.createElement(Icon, { color: "currentColor", width: "24px" })),
        React.createElement(Details, null,
            React.createElement(Text, { bold: true }, title),
            description && React.createElement(Text, { as: "p" }, description)),
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { size: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$f, { width: "24px", color: "currentColor" }))))));
};
var templateObject_1$5, templateObject_2, templateObject_3, templateObject_4;

var Separator = styled.li(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  align-items: center;\n  color: currentColor;\n  display: flex;\n  justify-content: center;\n  padding-left: 16px;\n  padding-right: 16px;\n"], ["\n  align-items: center;\n  color: currentColor;\n  display: flex;\n  justify-content: center;\n  padding-left: 16px;\n  padding-right: 16px;\n"])));
var StyledBreadcrumbs = styled.ul(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  align-items: center;\n  color: ", ";\n  display: flex;\n  list-style-type: none;\n\n  ", "\n"], ["\n  align-items: center;\n  color: ", ";\n  display: flex;\n  list-style-type: none;\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
...
var DefaultSeparator = React.createElement(Icon$d, { color: "currentColor", width: "24px" });
...
var Container = styled.div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var templateObject_1$e, templateObject_2$2;
...
var Placeholder = styled.div(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"])));
...
var Input = styled.input(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"], ["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
...
var GridLayout = styled.div(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: repeat(6, 1fr);\n  grid-gap: 16px;\n  ", " {\n    grid-template-columns: repeat(8, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 32px;\n  }\n"], ["\n  display: grid;\n  grid-template-columns: repeat(6, 1fr);\n  grid-gap: 16px;\n  ", " {\n    grid-template-columns: repeat(8, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 32px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var GridLayout$1 = styled(GridLayout)(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  & > div {\n    grid-column: span 6;\n    ", " {\n      grid-column: span 4;\n    }\n  }\n"], ["\n  & > div {\n    grid-column: span 6;\n    ", " {\n      grid-column: span 4;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var StyledProgress = styled.div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  position: relative;\n  background-color: ", ";\n  border-radius: 32px;\n  box-shadow: ", ";\n  height: 16px;\n  overflow: hidden;\n"], ["\n  position: relative;\n  background-color: ", ";\n  border-radius: 32px;\n  box-shadow: ", ";\n  height: 16px;\n  overflow: hidden;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var templateObject_1$o, templateObject_2$4;
...
var float = keyframes(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
var Container$1 = styled.div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var RotatingPancakeIcon = styled(Icon$B)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled(Icon$A)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$q, templateObject_2$5, templateObject_3$1, templateObject_4$1, templateObject_5;
...
var pulse = keyframes(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"], ["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"])));
var Root = styled.div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  min-height: 20px;\n  display: block;\n  background-color: ", ";\n  width: ", ";\n  height: ", ";\n  border-radius: ", ";\n"], ["\n  min-height: 20px;\n  display: block;\n  background-color: ", ";\n  width: ", ";\n  height: ", ";\n  border-radius: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.backgroundDisabled;
}, function (_a) {
    var width = _a.width;
...
var Skeleton = function (_a) {
    var width = _a.width, height = _a.height, _b = _a.variant, variant$1 = _b === void 0 ? variant.RECT : _b, _c = _a.animation, animation$1 = _c === void 0 ? animation.PULSE : _c;
    return (React.createElement(React.Fragment, null,
        animation$1 === animation.PULSE && React.createElement(Pulse, { variant: variant$1, width: width, height: height }),
        animation$1 === animation.WAVES && React.createElement(Waves, { variant: variant$1, width: width, height: height })));
};
var templateObject_1$r, templateObject_2$6, templateObject_3$2, templateObject_4$2, templateObject_5$1;

var Handle = styled.div(templateObject_1$s || (templateObject_1$s = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n  height: 32px;\n  left: 4px;\n  position: absolute;\n  top: 4px;\n  transition: left 200ms ease-in;\n  width: 32px;\n  z-index: 1;\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n  height: 32px;\n  left: 4px;\n  position: absolute;\n  top: 4px;\n  transition: left 200ms ease-in;\n  width: 32px;\n  z-index: 1;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.toggle.handleBackground;
});
var Input$1 = styled.input(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  cursor: pointer;\n  opacity: 0;\n  height: 100%;\n  position: absolute;\n  width: 100%;\n  z-index: 3;\n\n  &:checked + ", " {\n    left: calc(100% - 36px);\n  }\n\n  &:focus + ", " {\n    box-shadow: ", ";\n  }\n\n  &:hover + ", ":not(:disabled):not(:checked) {\n    box-shadow: ", ";\n  }\n"], ["\n  cursor: pointer;\n  opacity: 0;\n  height: 100%;\n  position: absolute;\n  width: 100%;\n  z-index: 3;\n\n  &:checked + ", " {\n    left: calc(100% - 36px);\n  }\n\n  &:focus + ", " {\n    box-shadow: ", ";\n  }\n\n  &:hover + ", ":not(:disabled):not(:checked) {\n    box-shadow: ", ";\n  }\n"])), Handle, Handle, function (_a) {
    var theme = _a.theme;
    return theme.shadows.focus;
}, Handle, function (_a) {
    var theme = _a.theme;
...
var templateObject_1$s, templateObject_2$7, templateObject_3$3;
...
var makeRender = function (valueT, render, row) {
    return render ? function () { return render({ row: row, value: valueT }); } : function () { return valueT; };
};
...
var createReducer = function () { return function (state, action) {
    switch (action.type) {
        case "SET_ROWS": {
            var rows = __spreadArrays(action.data);
        ...
        case "GLOBAL_FILTER": {
            ...
            var selectedRowsById_1 = {};
            state.selectedRows.forEach(function (row) {
                selectedRowsById_1[row.id] = !!row.selected;
            });
            return __assign(__assign({}, state), { rows: filteredRows.map(function (row) {
                    return selectedRowsById_1[row.id] ? __assign(__assign({}, row), { selected: selectedRowsById_1[row.id] }) : __assign({}, row);
                }), filterOn: true });
        }
        case "SEARCH_STRING": {
            var stateCopySearch = __assign({}, state);
...
var CloseButton = styled(Button)(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  padding: 8px;\n  width: 48px;\n"], ["\n  padding: 8px;\n  width: 48px;\n"])));
var Modal = function (_a) {
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            ...
            React.createElement(CloseButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$f, { color: "primary", onClick: onDismiss }))),
        React.createElement(Flex, { flexDirection: "column", p: "24px" }, children)));
};
...
var ModalProvider = function (_a) {
    ...
    return (React.createElement(Context.Provider, { value: {
        ...
        isOpen && (React.createElement(ModalWrapper, null,
            React.createElement(Overlay, { show: true, onClick: handleDismiss }),
...
var useModal = function (modal) {
    var _a = useContext(Context), onPresent = _a.onPresent, onDismiss = _a.onDismiss;
...
var MenuButton = styled(Button)(templateObject_1$w || (templateObject_1$w = __makeTemplateObject(["\n  color: ", ";\n  padding: 0 8px;\n  border-radius: 8px;\n"], ["\n  color: ", ";\n  padding: 0 8px;\n  border-radius: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$F, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$E, { width: "24px", color: "textSubtle" }))),
...
var MenuEntry = styled.div(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n  svg {\n    fill: ", ";\n  }\n  &:hover {\n    background-color: ", ";\n  }\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n  svg {\n    fill: ", ";\n  }\n  &:hover {\n    background-color: ", ";\n  }\n  // Safari fix\n  flex-shrink: 0;\n"])), MENU_ENTRY_HEIGHT, function (_a) {
...
var templateObject_1$y, templateObject_2$9;
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick },
            icon,
            React.createElement(LinkLabel, { isPushed: isPushed }, label),
            isOpen ? React.createElement(Icon$7, null) : React.createElement(Icon$6, null)),
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState }, isPushed &&
...
var PriceLink = styled.a(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var SettingsEntry = styled.div(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 8px;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 8px;\n"])), MENU_ENTRY_HEIGHT);
...
var templateObject_1$B, templateObject_2$b, templateObject_3$5, templateObject_4$3;
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Link, { fontSize: "14px", href: "https://bscscan.com/address/" + account, target: "blank", rel: "noopener noreferrer", mb: "32px" },
            React.createElement(Icon$n, { width: "20px", color: "primary", mr: "4px" }),
            "View on BscScan"),
...
var Menu = function (_a) {
    ...
    useEffect(function () {
        ...
        var debouncedHandleScroll = debounce(handleScroll, 300, { leading: true, trailing: true });
...
var templateObject_1$E, templateObject_2$c, templateObject_3$6, templateObject_4$4, templateObject_5$2;
...
var Toast = function (_a) {
    ...
    return (React.createElement(CSSTransition, __assign({ nodeRef: ref, timeout: 250, style: style }, props),
        React.createElement(StyledToast, { ref: ref, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave },
            React.createElement(Alert, { title: title, description: description, variant: alertTypeMap[type], onClick: handleRemove }))));
};
var templateObject_1$F;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#FFFFFF" });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#191326", backgroundDisabled: "#362C45", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#A28BD4", borderColor: "#524B63", card: "#27262c" });
...
export { Icon$4 as AddIcon, Alert, Icon$5 as ArrowDownIcon, Icon$6 as ArrowDropDownIcon, Icon$7 as ArrowDropUpIcon, Icon$8 as ArrowForwardIcon, BackgroundImage, GridLayout as BaseLayout, Icon$9 as BinanceIcon, Icon$2 as BlockIcon, Breadcrumbs, Button, ButtonMenu, ButtonMenuItem, Card, CardBody, CardFooter, CardRibbon, Icon$a as CardViewIcon, GridLayout$1 as CardsLayout, Checkbox, Icon as CheckmarkCircleIcon, Icon$b as CheckmarkIcon, Icon$c as ChevronDownIcon, Icon$d as ChevronRightIcon, Icon$e as ChevronUpIcon, Icon$f as CloseIcon, Icon$g as CogIcon, Icon$h as CommunityIcon, Dropdown, Icon$1 as ErrorIcon, Flex, Heading, Icon$i as HelpIcon, IconButton, Image, Icon$3 as InfoIcon, Input, Link, LinkExternal, Icon$j as ListViewIcon, Icon$k as LogoIcon, Icon$l as LogoRoundIcon, Menu, Icon$m as MinusIcon, Modal, ModalProvider, Icon$n as OpenNewIcon, Icon$p as PancakeRoundIcon, Icon$o as PancakesIcon, Progress, Icon$s as ProgressBunny, Radio, Icon$q as RemoveIcon, ResetCSS, Icon$w as SearchIcon, Skeleton, Spinner, Svg, Icon$x as SwapVertIcon, Icon$y as SyncAltIcon, Tag, Text, Icon$u as Ticket, Icon$v as TicketRound, ToastContainer, Toggle, Icon$r as VerifiedIcon, Icon$z as WarningIcon, Icon$t as Won, variants$1 as alertVariants, byTextAscending, byTextDescending, createReducer, darkTheme as dark, darkColors, lightTheme as light, lightColors, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
