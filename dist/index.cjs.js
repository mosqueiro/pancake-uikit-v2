...
var ExpandableButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React__default['default'].createElement(Icon$1g, { color: "invertedContrast" }) : React__default['default'].createElement(Icon$1j, { color: "invertedContrast" })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default['default'].createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default['default'].createElement(Icon$1g, { color: "primary" }) : React__default['default'].createElement(Icon$1j, { color: "primary" }) }, children));
};
...
var Avatar = function (_a) {
    ...
    var icon = (React__default['default'].createElement("img", { src: "/images/certik.png", alt: "profile avatar", height: "129px", width: "32px" }));
    return (React__default['default'].createElement(StyledAvatar, { title: username }, icon));
};
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, newcakePriceUsd = _a.newcakePriceUsd, links = _a.links, profile = _a.profile, children = _a.children;
...
exports.PancakeRoundBoost = Icon$U;
